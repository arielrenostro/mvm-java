...
public class MemoriaTest {
	...
	@Test
	public void testeTamanho() throws PosicaoMemoriaInvalidaException {
		Memoria memoria = new Memoria((short) 16);
		memoria.getData((short) 15);
	}

	@Test
	public void testeTamanhoError() throws PosicaoMemoriaInvalidaException {
		Memoria memoria = new Memoria((short) 16);
		try {
	...
	@Test
	public void testeData() throws PosicaoMemoriaInvalidaException {
		Memoria memoria = new Memoria((short) 16);
	...
	@Test
	public void testeTamanhoMaximo() throws PosicaoMemoriaInvalidaException {
