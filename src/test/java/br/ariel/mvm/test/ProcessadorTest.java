...
public class ProcessadorTest {
	...
	public void prepararPerifericos() {
		...
		processadorController.definirRegistradores(processador, memoria);
	}
	...
	public void testeMovAxBx() throws SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, PosicaoMemoriaInvalida, InterruptedException, InstrucaoInvalidaException {
		...
		Assert.assertEquals(511, processador.getBp());
		Assert.assertEquals(511, processador.getSp());
	}
	...
	public void testPushAx() throws SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, PosicaoMemoriaInvalida, InterruptedException, InstrucaoInvalidaException {
		...
		Assert.assertEquals(0, processador.getCx());
		Assert.assertEquals(511, processador.getBp());
		Assert.assertEquals(509, processador.getSp());
	}

	@Test
	public void testInitAx() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.INIT_AX);
		adicionarInstrucao(Instrucao.HALT);
	...
	@Test
	public void testInitAx2() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.INIT_AX);
		adicionarInstrucao(Instrucao.MOV_AX_LITERAL);
		adicionarInstrucao(0x0A);
		adicionarInstrucao(0xF0);
	...
	@Test
	public void testMovBxAx() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.MOV_AX_LITERAL);
		adicionarInstrucao(0x14);
		adicionarInstrucao(0x00);
		adicionarInstrucao(Instrucao.MOV_BX_AX);
	...
	@Test
	public void testMovCxAx() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.MOV_AX_LITERAL);
		adicionarInstrucao(0x14);
		adicionarInstrucao(0x00);
		adicionarInstrucao(Instrucao.MOV_CX_AX);
	...
	@Test
	public void testMovAxMem() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
	...
	@Test
	public void testMovAxMemBxP() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.MOV_AX_LITERAL);
	...
	@Test
	public void testMovAxMemBpS() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.MOV_AX_LITERAL);
		adicionarInstrucao(0x01);
		adicionarInstrucao(0x00);
	...
	@Test
	public void testMovAxMemBpP() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.MOV_AX_LITERAL);
		adicionarInstrucao(0x01);
		adicionarInstrucao(0x00);
		adicionarInstrucao(Instrucao.MOV_BP_AX);
	...
	@Test
	public void testMovMemAx() throws PosicaoMemoriaInvalida, SemProcessadorException, SemMemoriaException, MemoriaSemTamanhoException, InterruptedException, InstrucaoInvalidaException {
		adicionarInstrucao(Instrucao.MOV_AX_LITERAL);
	...
	private void adicionarInstrucao(int b) throws PosicaoMemoriaInvalida {
		memoria.setData(idx++, (byte) b);
	}

	private void adicionarInstrucao(Instrucao instrucao) throws PosicaoMemoriaInvalida {
